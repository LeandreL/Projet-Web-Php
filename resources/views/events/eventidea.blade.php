...
<div class="title"> BDE Idée d'évenement 
	<p><a href="/sendidea">Proposer une idée</a></p>
	</div>
	<div>
		@foreach ($events as $evenement) <!-- Affiche toutes les idées d'évènements pour les étudiants -->
